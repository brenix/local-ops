...
//timoni:generate timoni vendor crd -f https://raw.githubusercontent.com/cilium/cilium/refs/heads/main/pkg/k8s/apis/cilium.io/client/crds/v2alpha1/ciliumbgppeerconfigs.yaml
...
#CiliumBGPPeerConfigSpec: {
	...
	ebgpMultihop?: int32 & int & <=255 & >=1 | *1
	...
	gracefulRestart?: {
		...
		restartTimeSeconds?: int32 & int & <=4095 & >=1 | *120
	}
	...
	timers?: {
		...
		connectRetryTimeSeconds?: int32 & int & <=2147483647 & >=1 | *120
		...
		holdTimeSeconds?: int32 & int & <=65535 & >=3 | *90
		...
		keepAliveTimeSeconds?: int32 & int & <=65535 & >=1 | *30
	}
	...
	transport?: {
		...
		peerPort?: int32 & int & <=65535 & >=1 | *179
	}
}
