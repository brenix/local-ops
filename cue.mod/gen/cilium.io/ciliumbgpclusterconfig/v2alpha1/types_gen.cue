...
//timoni:generate timoni vendor crd -f https://raw.githubusercontent.com/cilium/cilium/refs/heads/main/pkg/k8s/apis/cilium.io/client/crds/v2alpha1/ciliumbgpclusterconfigs.yaml
...
#CiliumBGPClusterConfigSpec: {
	...
	bgpInstances!: list.MaxItems(16) & [...{
		...
		peers?: [...{
			...
			peerASN?: int64 & int & <=4294967295 & >=0 | *0
